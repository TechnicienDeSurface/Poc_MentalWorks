...
// définition manuel d'un id pour respecter le format demandé du JSON
// array_splice permet de mettre l'id au début du tableau 
...
// message d'erreur pour les valeurs incorrects
    ...
    // sécurisation du formulaire par les fonction htmlspécialchars & htmlentities
  ...
  <form class="space-y-4" action="http://51.91.108.32/registrations" method="post">
    <div class="grid grid-cols-2 gap-4">
      <div class="space-y-2">
        ...
        <!-- affichage message erreur en cas de valeur érronée -->
